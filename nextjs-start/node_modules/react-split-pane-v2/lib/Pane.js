...
function PaneStyle(_ref) {
  ...
  style[styleProp.minSize] = (0, _utils.convertSizeToCssValue)(minSize, resizersSize);
  style[styleProp.maxSize] = (0, _utils.convertSizeToCssValue)(maxSize, resizersSize);

  switch ((0, _utils.getUnit)(value)) {
    case 'ratio':
      style.flex = value;
      break;
    case '%':
    case 'px':
      style.flexGrow = 0;
      style[styleProp.size] = (0, _utils.convertSizeToCssValue)(value, resizersSize);
      break;
  }
